...
2)Quindi i core devo collaborare per verificare se nel vettore esista almeno un elemento uguale al valore beta. 
...
int main()
{
    ...
    printf("ci sono ben %d valori uguali nel vettore", contatore);
